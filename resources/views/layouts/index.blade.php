...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="{{ asset('UI_QUIZ/assets/icons/bootstrap-icons/font/bootstrap-icons.min.css')}}"
    />
  ...
  <body>
    ...
    <div class="section-wrap">
      ...
      <section class="navbar-custom">
        <div class="logo-sekolah-wrap">
          <a href="#" class="logo-sekolah">
            <img
              class="img-logo-nav"
              src="{{ asset('UI_QUIZ/assets/images/logoSekolah.png')}}"
              alt="logo-sekolah"
            />
            <span>SKPH Quiz</span>
          </a>
      ...
      <section id="main-content-custom" class="main-content-custom">
        ...
        <div id="play-menu-container" class="play-menu-container">
          <ul class="play-menu">
            <li>
              <a href="#" id="btn-play-quiz" class="fs-icon-custom1"
                ><i class="fa-regular fa-circle-play"></i>Play</a
              >
            </li>
            <li>
              <a href="{{ route('login') }}" id="btn-leave-quiz" class="fs-icon-custom1"
                ><i class="fa-solid fa-door-closed"></i
                ><i class="fa-solid fa-door-open"></i>Ruang Guru</a
              >
            </li>
          </ul>
        </div>
        ...
        <div id="nickname-container" class="nickname-container fade-in">
          ...
          <input
            type="text"
            name=""
            id="input-nickname-murid"
            class="input-nickname fade-in"
            placeholder="Klik disini"
          />

          <button
            id="btn-nm-mulai"
            class="btn-nm btn-nm-mulai"
            role="button"
            onclick="window.location.href='{{ route('murid.mapel') }}'"
          >
            Mulai
          </button>
      ...
      <section class="footer-custom">
        ...
        <a id="skph-link" href="" class="skph-link"
          >Sekolah Kristen Pelita Hati</a
        >
      </section>
    </div>
    ...
    <video autoplay muted loop id="bg-halloween">
      <source
        id="bg-video"
        src="{{ asset('UI_QUIZ/assets/video/bg-main-murid.mp4')}}"
        type="video/mp4"
      />
    </video>
