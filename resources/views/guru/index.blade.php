            ...
            <li class="nav-item">
                ...
                <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ asset('sistem-mulmet/template/RuangAdmin/alerts.html')}}">Alerts</a>
            <a class="collapse-item" href="{{ asset('sistem-mulmet/template/RuangAdmin/buttons.html')}}">Buttons</a>
            <a class="collapse-item" href="{{ asset('sistem-mulmet/template/RuangAdmin/dropdowns.html')}}">Dropdowns</a>
            <a class="collapse-item" href="{{ asset('sistem-mulmet/template/RuangAdmin/modals.html')}}">Modals</a>
            <a class="collapse-item" href="{{ asset('sistem-mulmet/template/RuangAdmin/popovers.html')}}">Popovers</a>
            <a class="collapse-item" href="{{ asset('sistem-mulmet/template/RuangAdmin/progress-bar.html')}}">Progress Bars</a>
          </div>
        </div>
      </li>
      <li class="nav-item">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false">
                <img class="img-profile rounded-circle" src="../../assets/images/contohUser1.jpg"
