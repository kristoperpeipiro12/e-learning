...
<head>
    ...
    <link href="{{ asset(path: 'sistem-mulmet/assets/images/logoSekolah.png') }}" rel="icon">
            ...
            <li class="nav-item">
                ...
                <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item"
                            href="{{ asset('sistem-mulmet/template/RuangAdmin/dropdowns.html')}}">Dropdowns</a>
                        <a class="collapse-item"
                            href="{{ asset('sistem-mulmet/template/RuangAdmin/modals.html')}}">Modals</a>
                        <a class="collapse-item"
                            href="{{ asset('sistem-mulmet/template/RuangAdmin/popovers.html')}}">Popovers</a>
                        <a class="collapse-item"
                            href="{{ asset('sistem-mulmet/template/RuangAdmin/progress-bar.html')}}">Progress Bars</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
